  ...
  <div class="pan-zoom-container" ref="container">
    ...
    <div class="controls-overlay">
      <div class="btn-group d-flex flex-column gap-2">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path d="M8 3a5 5 0 104.546 2.914.5.5 0 00-.908-.417A4 4 0 118 4a.5.5 0 000-1zm3.854.146a.5.5 0 010 .708l-3 3a.5.5 0 01-.708-.708l3-3a.5.5 0 01.708 0z"/>
          </svg>
        </button>
      </div>
    </div>
...
const handleTouchMove = (e) => {
  if (e.touches.length === 1 && isPanning.value) {
    ...
    const newScale = Math.max(props.minScale, Math.min(props.maxScale, touchStartScale.value + scaleDelta))
